...
**Initial Liquidity Pools \(LPs\) for farming BIT tokens:**
...
**\*\*\[**Get your FLIP tokens \(Bitexblock Liquidity Provider Tokens\) HERE**\]\(**[https://dex.bitexblock.com/\#/swap](https://dex.bitexblock.com/#/swap)**\)**.\*\*
