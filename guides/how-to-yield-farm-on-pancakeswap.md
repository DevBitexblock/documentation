# How to Yield Farm on Bitexblock
...
1. **Go to the farm page** [**here**](https://dex.bitexblock.com/farms)**.**
...
**3. Pick which farm you want to use. For this example, we will pick the BIT-BNB farm.**
...
**4. Go to the exchange page** [**here**](https://dex.bitexblock.com/?_gl=1*rbtvb8*_ga*MTUzNDEzNDQxMy4xNjAwNzkzNDM4*_ga_334KNG3DMQ*MTYwNDA2MDUwMS40OC4xLjE2MDQwNjU0NTIuMA..#/swap) **and click “Pool” and then “Add Liquidity”.**
...
**5. Select the tokens to add, in this case BNB and BIT. You need to provide them in a 50/50 ratio vs USD value.**

**For example, you would need to add $10 of BNB and $10 of BIT. Once you are done, click “Supply”.**
...
**7. You now have liquidity tokens. Next, go back to the farm page** [**here**](https://dex.bitexblock.com/farms)**.**
...
**11. Done! Now you are farming BIT tokens!**
