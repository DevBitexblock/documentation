---
description: Yield Farming on Bitexblock is easy!
---

# How to Use Farms


Yield Farming in Farms is a great way to earn BIT rewards on Bitexblock.

Unlike Syrup Pools, Farms require you to stake **two tokens** to get LP Tokens, which you then stake in the Farm to earn rewards. This lets you earn BIT while still keeping a position in your other tokens!
...
You’re going to need some "LP Tokens" to enter into a Farm with. Farms can only accept their own exact LP Token; for example, the BIT-BNB Farm will only accept BIT-BNB LP Tokens.

To get the exact LP Token, you'll need to provide liquidity for that trading pair. So to get BIT-BNB LP Tokens, you'll first have to provide liquidity for the BIT-BNB pair.

It may sound intimidating, but it's not too complicated. Let's go through step by step.

### Finding your Farm

Before you proceed, you'll want to choose a Farm that's right for you. [Visit the Farms page](https://dex.bitexblock.com/farms) and you’ll see a list of available Farms.
...
BIT-BNB and BUSD-BNB are pinned to the top of the list with the default **Hot** sorting. After the pinned Farms, Hot will show other Farms in order of how new they are.

You can choose another sorting option if you like, such as by **APR** for the Farms with the highest reward rate currently.

When you find a Farm that you'd like to use, note down the trading pair, e.g. BNB-BIT in case you need it later.
...
This will open the Add Liquidity page for your Farm's pair. We have a [guide to adding liquidity](https://docs.bitexblock.com/get-started/liquidity-guide) you can follow to get your LP Tokens.
...
1. Go back to the [Farms page](https://dex.bitexblock.com/farms) and locate your Farm. Click anywhere on the row showing your pair. It will expand to show more details.
...
1. Return to the [Yield Farms page](https://dex.bitexblock.com/farms). At the top of the page you'll see a **Staked only** toggle. Click the toggle.
...
Farming will bring you BIT rewards over time. You can collect these rewards and use them to get more LP Tokens, stake them in Syrup Pools, use them to play Lottery, or anything else you’d like.
...
To collect your rewards, you’ll need to visit your chosen Farm and collect the BIT waiting for you.

1. Return to the Farms page [here](https://dex.bitexblock.com/farms).
2. Find the Farm you staked your LP Tokens in, and click the row to view details. You should see an estimate of your rewards under “Bit earned”.
...
1. Click the **Harvest** button and confirm the action in your wallet. After a short wait, the BIT will be claimed to your wallet for you to use as you like.
...
And that's all there is to it! You may also want to look at [how to use Bitexblock Syrup Pools](https://docs.bitexblock.com/get-started/syrup-pool-guide) to earn rewards.
